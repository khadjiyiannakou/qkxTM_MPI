...
int main(int argc,char* argv[]){
  ...
  char file_in[257] = "/home/khadjiyiannakou/qkxTM_MPI/test/tDil/inSpinor";
  char file_out[257] = "/home/khadjiyiannakou/qkxTM_MPI/test/tDil/inSpinorHPE";
...
//MPI_Abort(MPI_COMM_WORLD,ierr);
  ...
  vec_in->applyGamma5(*vec_tmp,&latInfo);

  vec_tmp->applyDslash(*vec_in,*gauge);
  vec_in->applyTwistDagInv(*vec_tmp,&latInfo);
  ...
  vec_tmp->applyGamma5(*vec_in,&latInfo);
